...
@section('title', 'Términos para ver contenido adulto')
...
<div class="container mt-5 mb-5">
    ...
    <h4 class="fw-bold mb-3 text-center">
        Términos para ver contenido adulto
    </h4>

    <p class="text-secondary text-center mb-4">
        Configura las condiciones que deben aceptar los usuarios para poder visualizar contenido adulto.
    </p>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card shadow-sm border-0 p-4 mb-4" style="border-radius:16px;">
                ...
                <form method="POST"
                      action="{{ route('adult.view_terms.update', $term) }}"
...
function previewIcon(input) {
    ...
    const preview = input.parentElement.querySelector('img[id^="preview-icon"]');
    const current = input.parentElement.querySelector('img[id^="current-icon"]');
